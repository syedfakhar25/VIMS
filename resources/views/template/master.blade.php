    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard')}}">
            <div class="sidebar-brand-icon rotate-n-15">
                <i class="fas "> <img src="{{asset('main_logo.png')}}" width="80%" height="auto"></i>
            </div>
            <div class="sidebar-brand-text mx-3" style="font-size: 30px"><b>VMS</b></div>
        </a>
        ...
        <li class="nav-item active">
            <a href="{{route('vehicle.index')}}" class="nav-link" href="index.html">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; ITB AJK</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<script src="{{asset('js/sb-template-2.min.js')}}"></script>
